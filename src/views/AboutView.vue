...
<template>
  <div class="container mx-auto my-46 p-12">
    ...
    <svg id="circ" width="400" height="400" viewBox="0 0 600 600">
      <!-- Oval path, no fill -->
      <ellipse id="path" cx="300" cy="300" rx="200" ry="200" fill="none" stroke="red" stroke-width="2" />
    </svg>
    <svg id="planet" width="91" height="90" viewBox="0 0 91 90" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
      ...
      <path
        ...
        fill="#D0FB66" stroke="#4D6514" style="
          fill: #d0fb66;
  ...
  <div class="border-brdr container flex place-content-center place-self-center border">
    <div class="flex-flex-col">
      ...
      <div class="mt-2 flex gap-2">
        <div class="text-fg-prim bg-acc-prim flex size-22 items-center justify-center text-center text-2xl"></div>
        <div class="text-fg-sec bg-acc-sec flex size-22 items-center justify-center text-center text-2xl"></div>
        <div class="text-fg-ter bg-acc-ter flex size-22 items-center justify-center text-center text-2xl"></div>
      </div>
      <div class="border-brdr from-acc-prim via-acc-sec to-acc-ter mt-2 flex h-22 w-70 gap-2 border bg-gradient-to-r">
      </div>
  ...
  <TheContainer>
    <div class="flex h-full w-full gap-6 p-8">
      <TheDialog open-dialog-button-title="quick view" openButtonVariant="tertiary"
        open-button-classes="hover:text-acc-prim border rounded" close-button-variant="tertiary"
  ...
  <div class="relative flex items-center justify-center w-40 h-40">
    <!-- Glow aura -->
    <div
      class="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_center,var(--acc-primary)_0%,transparent_70%)] blur-xl opacity-50">
    </div>

    <!-- Glass dome -->
    <div
      class="relative z-10 rounded-full bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.2)_0%,rgba(0,0,0,0.8)_90%)] border border-[rgba(255,255,255,0.3)] backdrop-blur-md shadow-[0_0_20px_var(--acc-primary)] overflow-hidden"
      style="aspect-ratio: 1/1;">
      <!-- Goo -->
      <div
        class="absolute bottom-0 left-0 w-full h-1/2 rounded-b-full bg-gradient-to-t from-[var(--acc-primary)] to-[rgba(0,255,200,0.1)] opacity-70">
      </div>

      <!-- Project icon -->
      <img :src="icon" alt="project icon" class="absolute inset-0 m-auto w-1/2 h-1/2 object-contain select-none" />
    </div>

    <!-- Jar base -->
    <div class="absolute -bottom-2 w-2/3 h-4 bg-[var(--bg-tertiary)] rounded-full shadow-inner"></div>
  </div>
</template>
<style scoped>
.diagonal {
