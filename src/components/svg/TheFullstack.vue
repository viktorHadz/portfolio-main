...
function createGridTimeline() {
  ...
  return gsap
    ...
    .to(zeros, { fill: '#58ba11', duration: 0.5, stagger: 0.05 })
    .to(zeros, { fill: '', duration: 0.5, stagger: 0.05 })
    .to(ones, { fill: '#58ba11', duration: 0.5, stagger: 0.05 })
...
function createClientDotTimeline() {
  return (
    gsap
      ...
      // Forward
      .to('#fwd-color-change-1', { fill: '#AFD84B', duration: 0.2 })
      .to('#dot-front', moveDot(0, 0.5))
      .to('#mid-color-change-2', { fill: '#AFD84B', duration: 0.2 })
      .to('#dot-front', moveDot(0.5, 1))
      .to('.back-color-change-3', { fill: '#AFD84B', duration: 0.2 })
      // Reverse
    ...
    >
      <g id="all-devs-and-connector">
        <g id="connectors">
          ...
          <path
            id="dot-front"
            class="fill-[#ffeb58] stroke-black stroke-1"
            d="M301 449.1c4 0 7.6 1 10.1 2.7 2.6 1.6 4.1 3.8 4.1 6.1 0 2.4-1.5 4.6-4 6.2a19 19 0 0 1-10.2 2.7c-4 0-7.5-1-10-2.7-2.6-1.6-4.1-3.8-4.1-6.2 0-2.3 1.5-4.5 4-6.1A19 19 0 0 1 301 449Z"
          />
        </g>
        ...
        <g id="forward-devc">
          ...
          <path
            ...
            class="fill-[#ffeb58] stroke-black"
          />
          <path
            id="Vector_13"
            fill="#fff"
          ...
          <path
            ...
            d="m382 405 65-38v25l-65 38v-25Z"
          />
          <g id="fwd-dev-cloud-and-bg" fill-opacity="1">
            <path
              id="bg"
